...
public class LoginTest2 {
	...
	public Object[][] getCredentials(){
		return new Object[][]{{new Login("fisbilling@xeno.com","Test@123","invpwd")},{new Login("fisr29@xeno.com","xeno@123","invuser")},
			{new Login("testuser","Abc@1234","invEmail")},{new Login("","","blank")}};
	}
