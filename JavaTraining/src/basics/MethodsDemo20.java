...
public class MethodsDemo20 {
	...
	//	MethodsDemo20.login20(approve, pay); // calling static method by passing objects as input
		
		//main method code at real time project level
		new MethodsDemo20().login10(new Dashboard());
		MethodsDemo20.login20(new ApproveBills(), new PayBills());
	}
}
