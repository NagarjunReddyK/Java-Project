...
public class LinkedHashMap4 {
	public static void main(String[] args) {
		...
		lhm.values().stream().forEach((qwe)->System.out.println(qwe.billId+"--"+qwe.billNumber));
		lhm.forEach((login,dash) -> System.out.println(login.username+"--"+login.password+"="+dash.billId+"--"+dash.billNumber));
	}
}
